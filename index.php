    ...
    <div class="descr">
        ...
        <h2 class="subtitle">Теперь пишем код на PHP</h2>
            ...
            <div class="descr">
                ...
                <p>ВАЖНО - не забываем, что в phpMyAdmin необходимо создать БД (у нас в коде она - mybd) и в данной БД создать таблицу(у нас коде таблица - mytb)с соответствующими полями.<br>
                    <ul>
